...
function initMap(business, latlng) {
  ...
  var settings = {
    "async": true,
    "crossDomain": true,
    "url": `https://cors-anywhere.herokuapp.com/https://api.yelp.com/v3/businesses/search?term=dogs&categories=breweries&limit=50&radius=20000&sort_by=distance&location=${window.searchText}`,
    "method": "GET",
    "headers": {
