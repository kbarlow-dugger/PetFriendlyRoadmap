...
function initMap(business, latlng) {
  ...
  var settings = {
    "async": true,
    "crossDomain": true,
    "url": `https://cors-anywhere.herokuapp.com/https://api.yelp.com/v3/businesses/search?categories=dog_parks&limit=50&radius=20000&sort_by=distance&location=${window.searchText}&term=${window.selectCat}`,
    "method": "GET",
    "headers": {
