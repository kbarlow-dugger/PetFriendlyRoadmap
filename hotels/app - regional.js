...
function initMap(business, latlng) {
  ...
  var settings = {
    "async": true,
    "crossDomain": true,
    "url": `https://cors-anywhere.herokuapp.com/https://api.yelp.com/v3/businesses/search?term=pet+friendly&categories=hotels&limit=100&radius=40000&sort_by=distance&location=${window.searchText}`,
    "method": "GET",
    "headers": {
