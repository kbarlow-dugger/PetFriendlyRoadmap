...
function initMap(business, latlng) {
  ...
  var settings = {
    "async": true,
    "crossDomain": true,
    "url": `https://cors-anywhere.herokuapp.com/https://api.yelp.com/v3/businesses/search?categories=breweries&limit=60&radius=20000&sort_by=rating&location=${window.searchText}&term=pet+friendly`,
    "method": "GET",
    "headers": {
